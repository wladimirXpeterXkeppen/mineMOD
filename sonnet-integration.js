 ...
 * Utility buttons are added synchronously when Utility is opened.
 * No setTimeout / MutationObserver injection is used.
 */
(()=>{
  "use strict";
  const install=()=>{
    ...
    ui.showCategory=function(category){
      ...
      missing.forEach(([name,handler],j)=>{
        ...
        b.type="button";b.className="galaxy-button";b.dataset.module=name;b.dataset.enabled="false";
